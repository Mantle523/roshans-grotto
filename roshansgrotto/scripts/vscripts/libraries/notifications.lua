...
--[[
  ...
  -Ensure that you have the roshansgrotto_notifications.xml, roshansgrotto_notifications.js, and roshansgrotto_notifications.css files in your panorama content folder.
  -Ensure that roshansgrotto_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/roshansgrotto_notifications.xml" />
