...
--[[
  ...
  -Ensure that you have the roshansgrotto_worldpanels.xml in your panorama content layout folder.
  -Ensure that you have the roshansgrotto_worldpanels.js in your panorama content scripts folder.
  -Ensure that roshansgrotto_worldpanels.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/roshansgrotto_worldpanels.xml" />
