...
--[[
  ...
  -Ensure that you have the roshansgrotto_attachments.xml, roshansgrotto_attachments.js, and roshansgrotto_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that roshansgrotto_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/roshansgrotto_attachments.xml" />
